  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-elegant rounded-none uppercase tracking-widest font-semibold",
        heroOutline: "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground rounded-none uppercase tracking-widest font-semibold",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 rounded-none font-semibold",
        premium: "bg-primary text-primary-foreground hover:shadow-hover hover:-translate-y-0.5 rounded-sm font-medium",
        subtle: "bg-transparent text-muted-foreground hover:text-foreground hover:bg-muted/50 rounded-sm",
      },
      size: {
